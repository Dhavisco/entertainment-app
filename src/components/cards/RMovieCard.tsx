...
<div className="w-full rounded-lg overflow-hidden">
  ...
  >
    {/* Small Device Image */} <div className="block sm:hidden"> <Image src={thumbnail.regular.small} alt={title} layout="fill" objectFit="cover" className="transition-transform rounded-lg duration-300" /> </div> 
    {/* Medium Device Image */} <div className="hidden sm:block md:hidden"> <Image src={thumbnail.regular.medium} alt={title} layout="fill" objectFit="cover" className="transition-transform rounded-lg duration-300" /> </div> 
    {/* Large Device Image */} <div className="hidden md:block"> <Image src={thumbnail.regular.large} alt={title} layout="fill" objectFit="cover" className="transition-transform rounded-lg duration-300" /> </div>
